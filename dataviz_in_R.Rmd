...
ggplot(homes_median_lotsize) +
  aes(x = yearbuilt, y = lotsize) +
  geom_line() +
  coord_cartesian(xlim = c(1930,2020), ylim = c(0,150)) +
...
There are whole R packages that provide nothing but more themes for ggplot2. For example, see the {ggthemes} package.
