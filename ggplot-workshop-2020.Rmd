...
```{r}
URL <- 'https://raw.githubusercontent.com/clayford/dataviz_with_ggplot2/master/homes.csv'
...
The large number of Average homes makes it difficult to see the counts for the other categories. An alternative approach is to view the proportion of homes with and without central air within each condition. We can do this setting the position argument to "fill".
